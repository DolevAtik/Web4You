...
פשוט לחצו פי פי על `index.html` ותראו את האתר בדפדפן.
...
### שינוי שם העסק
חפשו `Web4You` בקובץ והחליפו לשם העסק שלכם (יש כמה מופעים).
...
```
Web4You/
├── index.html          ← הקובץ הרئיסי (כל הקוד בקובץ אחד!)
├── SETUP.txt          ← הוראות התקנה מהירות
└── README.md          ← הקובץ הזה - תיעוד מלא
```
...
| בעיה | פתרון |
|------|--------|
| **הטופס לא שולח מיל** | וודאו שהחלפתם את המייל לשלכם בקובץ |
| **האנימציות לא עובדות** | הטעינו מחדש את הדף (Ctrl+R) או בדפדפן אחר |
...
יש שאלות? כל הקוד בתוך קובץ אחד - **קל מאוד לשנות ולעדכן!**

**טיפ**: כל פעם שתחפשו Find & Replace (Ctrl+H) בעדיטור, וודאו שאתם בקובץ `index.html`.
...
- [ ] שנו את המייל לשלכם
- [ ] שנו את מספר וואטסאפ לשלכם
- [ ] שנו את שם העסק מ-Web4You לשם שלכם
